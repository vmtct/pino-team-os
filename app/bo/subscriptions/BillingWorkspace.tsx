...
type Props = { lifecycle: BoLearnerLifecycle; paths: BoPathProgram[]; classes: BoRunningClass[]; onChanged: () => Promise<void> };
...
export function BillingWorkspace({ lifecycle, paths, classes, onChanged }: Props) {
