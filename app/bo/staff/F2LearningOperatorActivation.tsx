  ...
  return (
    <div className={styles.page}>
      <section className={styles.panel}>
        ...
        {state.status === "error" ? <div className={`${styles.state} ${styles.compactState} ${styles.errorState}`}><strong>Activation stopped</strong><span>{state.message}</span>{state.requestId ? <code>{state.requestId}</code> : null}</div> : null}
      </section>
    </div>
  );
}
