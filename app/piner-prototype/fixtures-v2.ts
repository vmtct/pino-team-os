...
export const scenarios: StudentScenario[] = [
  ...
  },
  {
    ...
    paths: [
      {
        ...
        package: { start: "12/08/2026", end: "25/08/2026", status: "TRIAL", note: "Trial 14 ngày · real Journey state" },
      },
    ],
    ...
    home: {
      ...
      cta: "Trở lại dự án",
      meta: "Trial Premium · Journey thật",
    ...
    collection: [
      { id: "han-free-1", kind: "Artwork", tier: "FREE", title: "Open Studio sketch", subtitle: "Free Collection", meta: "Trước Trial", emoji: "✏️", owned: true },
      { id: "han-art-1", kind: "Artwork", tier: "PREMIUM", title: "Khu rừng trong mơ · sketch", subtitle: "Work in progress", meta: "Trial Premium", emoji: "🌿", owned: true, trial: true, featured: true },
    ],
  },
  {
    key: "leo-expired",
    ...
    membershipLabel: "Trial đã hết hạn",
    ...
    paths: [
      {
        ...
        package: { start: "01/08/2026", end: "14/08/2026", status: "EXPIRED", note: "Trial đã hết · progression mới đang khóa" },
      },
    ],
    defaultPath: "PIANOHOUSE",
    home: {
      eyebrow: "Trial đã kết thúc · Progression locked",
      ...
      freshDescription: "Premium mở lại progression mới mà không làm mất lịch sử Trial.",
      freshEmoji: "🔒",
    },
    nextTouchpoint: null,
    exploreStatus: "eligible",
    ...
    collection: [
      ...
      { id: "leo-music-1", kind: "Music", tier: "PREMIUM", title: "Always With Me · L4", subtitle: "Retained Trial recording", meta: "Student-owned history", emoji: "🎹", owned: true, trial: true, featured: true },
      { id: "leo-mark-1", kind: "Milestone", tier: "PREMIUM", title: "Fundamental · L4", subtitle: "Achievement retained", meta: "Không hết hạn cùng access", emoji: "◆", owned: true, trial: true },
