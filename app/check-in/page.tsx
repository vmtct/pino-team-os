...
export default function CheckInPage() {
  ...
  async function submit(checkType: "Check in" | "Check out") {
    ...
    try {
      const response = await fetch(`/api/timesheet?t=${encodeURIComponent(mobile)}`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ checkType }) });
      const result = await response.json();
