    ...
    <PinoriaVietnameseLocale>
      ...
      >
        <div style={{ maxWidth: 1160, margin: "0 auto" }}>
          ...
          <header style={{ margin: "22px 0 28px" }}>
            <span style={{ fontSize: 10, fontWeight: 900, letterSpacing: ".18em", color: "rgba(231,193,211,.58)" }}>
              WORLD BROADCAST · LOST ARTIFACT
            </span>
            <h1 style={{ margin: "8px 0 7px", fontSize: "clamp(36px,5vw,66px)", lineHeight: .95, letterSpacing: "-.04em" }}>
              Thần Khí Thất Lạc
            </h1>
            ...
            {LOST_ARTIFACTS.map((artifact) => (
              <Link
                ...
                style={{
                  minHeight: 280,
                  display: "grid",
                  gridTemplateColumns: "minmax(150px,.8fr) 1.2fr",
                  gap: 18,
                  alignItems: "center",
                  padding: 18,
                  borderRadius: 24,
              ...
              >
                ...
                <div>
                  ...
                  <h2 style={{ margin: "8px 0 8px", fontSize: 27, lineHeight: 1.02 }}>{artifact.title}</h2>
                  <p style={{ margin: 0, color: "rgba(240,235,224,.5)", fontSize: 13, lineHeight: 1.5 }}>{artifact.clue}</p>
                  <strong style={{ display: "block", marginTop: 20, fontSize: 12, color: "rgba(247,235,219,.8)" }}>Mở broadcast →</strong>
                </div>
              </Link>
            ))}
          </section>
