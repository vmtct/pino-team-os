...
const routes = [
  ...
  {
    href: "/pinoria-tv/review/wish",
    title: "Gieo Ước · Dư Âm",
    meta: "Immutable Wish reveal · ×1 / ×5 / Perfect Memory · 11–17s",
    badge: "WISH · REVEAL",
  },
  {
    ...
    <PinoriaVietnameseLocale>
      ...
      >
        <div style={{ maxWidth: 1120, margin: "0 auto" }}>
          ...
          >
            Review order recommend: <strong style={{ color: "#f5f0e7" }}>Operational TV → Pinoria Shop → Túi Hành Trang → Hộ Linh Visual Registry → Gieo Ước · Dư Âm → Hạt Năng Lượng → Learning Spotlight → World Broadcast → Thần Khí Thất Lạc → World State Transition</strong>. Với Operational TV, mở Review controls để duyệt Arrival / Quick Choice / Companion Ritual / Departure trên cùng surface.
          </aside>
        </div>
      </main>
    </PinoriaVietnameseLocale>
