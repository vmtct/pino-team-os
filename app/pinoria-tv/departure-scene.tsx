...
export function DepartureScene({ subject }: { subject: DepartureSubject }) {
  ...
  return (
    ...
    >
      ...
      <section
        className="pinoriaDepartureCopy"
        style={{
          position: "absolute",
      ...
      <section
        aria-hidden="true"
        className="pinoriaDepartureCharacter"
        data-departure-hero-anchor
        style={{
          position: "absolute",
          ...
          aspectRatio: "1 / 1",
          zIndex: 3,
          animation: "pinoriaDepartureCharacter 8.6s cubic-bezier(.18,.8,.2,1) both",
      ...
      >
        ...
        <PrototypeCharacter
          ...
          wingMotion="idle"
          size="100%"
          style={{ position: "relative", zIndex: 2, filter: "drop-shadow(0 30px 30px rgba(0,0,0,.30))", animation: "pinoriaDepartureFloat 3.8s ease-in-out infinite" }}
        />
