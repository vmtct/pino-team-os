...
test("BO operational facade forwards only exact GET paths and the verified identity", async () => {
  ...
  const paths = ["delivery/bootstrap-state", "path-programs", "running-classes", "syllabi", "sessions", "sessions/0198d050-56c1-7ac5-b9ab-b0e45d912345/registrations", "sessions/0198d050-56c1-7ac5-b9ab-b0e45d912345/learning-owner"];
