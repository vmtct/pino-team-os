...
test("BO cannot reach TOS, Companion, Founder, or unapproved BO routes", () => {
  for (const pathname of [
    ...
    "/api/bo/workforce/staff-records/not-a-canonical-id", `/api/bo/students/${roleId}/pinoria/companions/${roleId}/ritual`, `/api/bo/students/${roleId}/pinoria/companions/not-a-canonical-id/feed`, "/api/bo/workforce/training/delete-all", "/api/bo/workforce/training/modules/not-a-canonical-id/retire", "/api/bo/workforce/planning/anything", "/api/bo/workforce/planning/assignment/cancel/anything", "/api/bo/workforce/planning/shift-templates/not-a-canonical-id/status", `/api/bo/workforce/planning/shift-templates/${roleId}/delete`, "/api/bo/workforce/timekeeping/not-a-canonical-id/corrections", `/api/bo/workforce/timekeeping/${roleId}/delete`, `/api/bo/workforce/timekeeping/${roleId}/corrections/extra`, "/api/bo/workforce/duty/checkout-exceptions/not-a-canonical-id/approve", `/api/bo/workforce/duty/checkout-exceptions/${roleId}/delete`, `/api/bo/workforce/duty/checkout-exceptions/${roleId}/approve/extra`,
