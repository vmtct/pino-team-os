...
test("BO root redirects on the same host and only governed BO routes are available", () => {
  ...
  for (const pathname of [
    ...
    "/api/bo/context", "/api/bo/pinoria/effects/catalog", "/api/bo/pinoria/ward/sets", `/api/bo/pinoria/ward/sets/${roleId}`, `/api/bo/pinoria/ward/sets/${roleId}/members`, "/api/bo/pinoria/ward/set-webm-assets", "/api/bo/pinoria/ward/learners", `/api/bo/pinoria/ward/learners/${roleId}`, `/api/bo/pinoria/ward/learners/${roleId}/grants`, `/api/bo/pinoria/ward/learners/${roleId}/revocations`, `/api/bo/pinoria/ward/learners/${roleId}/loadout`, "/api/bo/web-cms/slots", `/api/bo/web-cms/slots/${roleId}`, `/api/bo/web-cms/slots/${roleId}/history`, `/api/bo/web-cms/slots/${roleId}/draft`, `/api/bo/web-cms/slots/${roleId}/publish`, `/api/bo/web-cms/slots/${roleId}/rollback`, "/api/bo/pinoria/ward/catalog", "/api/bo/pinoria/ward/catalog/items", `/api/bo/pinoria/ward/catalog/items/${roleId}`, "/api/bo/pinoria/ward/catalog/variants", `/api/bo/pinoria/ward/catalog/variants/${roleId}`, "/api/bo/learners", "/api/bo/student-intakes", `/api/bo/student-intakes/${roleId}/void`, "/api/bo/practice/authoring-context", "/api/bo/practice/repertoire-access/context", "/api/bo/practice/repertoire-access", "/api/bo/practice/repertoire-access/grants", `/api/bo/practice/repertoire-access/grants/${roleId}/revoke`, "/api/bo/practice/resources", "/api/bo/practice/media", `/api/bo/practice/resources/${roleId}`, `/api/bo/practice/resources/${roleId}/drafts`, `/api/bo/practice/versions/${roleId}`, `/api/bo/practice/versions/${roleId}/pages`, `/api/bo/practice/versions/${roleId}/publish`, "/api/bo/open-studio/operations", "/api/bo/open-studio/passes", "/api/bo/open-studio/listings",
    ...
    "/api/bo/subscriptions", `/api/bo/subscriptions/${roleId}/renew`, `/api/bo/subscriptions/${roleId}/neutralize`, `/api/bo/subscriptions/${roleId}/projected-completion`,
    "/api/bo/billing/product-plans", `/api/bo/billing/product-plans/${roleId}/configure`, "/api/bo/billing/sales",
    `/api/bo/billing/bills/${roleId}`, `/api/bo/billing/bills/${roleId}/transactions`, `/api/bo/billing/bills/${roleId}/void`, `/api/bo/billing/transactions/${roleId}/void`,
    "/api/bo/enrollments", `/api/bo/enrollments/${roleId}/end`,
    "/api/bo/centers", "/api/bo/delivery/bootstrap-state", "/api/bo/delivery/enrollment-activation", "/api/bo/delivery/terms", "/api/bo/delivery/term-weeks", `/api/bo/delivery/term-weeks/${roleId}/update`, `/api/bo/delivery/term-weeks/${roleId}/delete`, "/api/bo/delivery/learning-spaces", "/api/bo/delivery/calendar-scope", "/api/bo/delivery/calendar-exclusions", "/api/bo/delivery/calendar-exclusions/preview", `/api/bo/delivery/calendar-exclusions/${roleId}`,
    ...
    "/staff-login", "/api/staff-auth/login", "/api/staff-auth/logout", "/api/staff-auth/status",
...
test("BO cannot reach TOS, Companion, Founder, or unapproved BO routes", () => {
  for (const pathname of [
    ...
    "/api/bo/billing/product-plans/not-a-canonical-id/configure", "/api/bo/billing/sales/extra", `/api/bo/billing/bills/${roleId}/delete`, "/api/bo/billing/bills/not-a-canonical-id", `/api/bo/billing/transactions/${roleId}/void/extra`,
