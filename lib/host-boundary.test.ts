...
test("BO root redirects on the same host and only governed BO routes are available", () => {
  ...
  for (const pathname of [
    ...
    "/api/bo/context", "/api/bo/pinoria/effects/catalog", "/api/bo/pinoria/ward/sets", `/api/bo/pinoria/ward/sets/${roleId}`, `/api/bo/pinoria/ward/sets/${roleId}/members`, "/api/bo/pinoria/ward/set-webm-assets", "/api/bo/pinoria/ward/learners", `/api/bo/pinoria/ward/learners/${roleId}`, `/api/bo/pinoria/ward/learners/${roleId}/grants`, `/api/bo/pinoria/ward/learners/${roleId}/revocations`, `/api/bo/pinoria/ward/learners/${roleId}/loadout`, "/api/bo/web-cms/slots", `/api/bo/web-cms/slots/${roleId}`, `/api/bo/web-cms/slots/${roleId}/history`, `/api/bo/web-cms/slots/${roleId}/draft`, `/api/bo/web-cms/slots/${roleId}/publish`, `/api/bo/web-cms/slots/${roleId}/rollback`, "/api/bo/pinoria/ward/catalog", "/api/bo/pinoria/ward/catalog/items", `/api/bo/pinoria/ward/catalog/items/${roleId}`, "/api/bo/pinoria/ward/catalog/variants", `/api/bo/pinoria/ward/catalog/variants/${roleId}`, "/api/bo/learners", "/api/bo/practice/authoring-context", "/api/bo/practice/repertoire-access/context", "/api/bo/practice/repertoire-access", "/api/bo/practice/repertoire-access/grants", `/api/bo/practice/repertoire-access/grants/${roleId}/revoke`, "/api/bo/practice/resources", "/api/bo/practice/media", `/api/bo/practice/resources/${roleId}`, `/api/bo/practice/resources/${roleId}/drafts`, `/api/bo/practice/versions/${roleId}`, `/api/bo/practice/versions/${roleId}/pages`, `/api/bo/practice/versions/${roleId}/publish`, "/api/bo/open-studio/operations", "/api/bo/open-studio/passes", "/api/bo/open-studio/listings",
