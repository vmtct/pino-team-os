...
test("BO root redirects on the same host and only governed BO routes are available", () => {
  ...
  for (const pathname of [
    "/bo", "/bo/", "/bo/staff", "/bo/workforce", "/bo/workforce/check-in-exceptions", "/bo/training", "/bo/learners", "/bo/open-studio", "/bo/delivery-activation",
    ...
    "/api/bo/workforce/staff-records", "/api/bo/workforce/staff-onboarding", "/api/bo/workforce/staff-registration-settings", "/api/bo/workforce/staff-registration-requests", "/api/bo/workforce/planning/check-in-exceptions", "/api/bo/workforce/planning/check-in-exceptions/centers", `/api/bo/workforce/planning/check-in-exceptions/${roleId}`, `/api/bo/workforce/planning/check-in-exceptions/${roleId}/approve`, `/api/bo/workforce/planning/check-in-exceptions/${roleId}/decline`, `/api/bo/workforce/staff-registration-requests/${roleId}/approve`, `/api/bo/workforce/staff-registration-requests/${roleId}/reject`, "/api/bo/workforce/training/catalog", "/api/bo/workforce/training/modules", `/api/bo/workforce/training/modules/${roleId}/next-draft`, `/api/bo/workforce/training/modules/${roleId}/retire`, `/api/bo/workforce/training/assignments/${roleId}/signoff`, `/api/bo/workforce/training/qualifications/${roleId}/revoke`, "/api/bo/workforce/planning/weekly", "/api/bo/workforce/planning/assignment", "/api/bo/workforce/planning/assignment/cancel",
