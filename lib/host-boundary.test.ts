...
test("BO root redirects on the same host and only governed BO routes are available", () => {
  ...
  for (const pathname of [
    ...
    "/api/bo/policies/open_studio/monthly_path_pass.v1/stream",
    "/api/bo/policies/open_studio/monthly_path_pass.v1/effective",
    "/api/bo/policies/open_studio/monthly_path_pass.v1/versions",
    "/api/bo/policies/open_studio/monthly_path_pass.v1/versions/0198d050-56c1-7ac5-b9ab-b0e45d912345/publish",
    "/api/bo/policies/open_studio/bring_a_friend.v1/stream",
    "/api/bo/policies/open_studio/public_acquisition.v1/versions",
    "/api/bo/policies/open_studio/cancellation.v1/effective",
...
test("BO cannot reach TOS, Companion, Founder, or unapproved BO routes", () => {
  for (const pathname of [
    ...
    "/api/bo/policies/open_studio/monthly_path_pass.v1/versions/not-a-canonical-id/publish",
    "/api/bo/policies/open_studio/unknown.v1/stream",
    "/api/bo/policies/open_studio/monthly_path_pass.v1/delete",
