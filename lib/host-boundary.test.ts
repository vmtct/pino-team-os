...
test("BO root redirects on the same host and only governed BO routes are available", () => {
  ...
  for (const pathname of [
    "/bo", "/bo/", "/bo/staff", "/bo/workforce", "/bo/workforce/check-in-exceptions", "/bo/workforce/timekeeping", "/bo/training", "/bo/learners", "/bo/open-studio", "/bo/delivery-activation",
    "/bo/running-classes", "/bo/sessions", "/bo/registrations", "/bo/syllabus", "/bo/practice", "/bo/pinoria-ward", "/bo/content",
    "/bo/system/users", "/bo/system/roles", "/bo/system/audit",
    "/api/bo/context", "/api/bo/web-cms/slots", `/api/bo/web-cms/slots/${roleId}`, `/api/bo/web-cms/slots/${roleId}/history`, `/api/bo/web-cms/slots/${roleId}/draft`, `/api/bo/web-cms/slots/${roleId}/publish`, `/api/bo/web-cms/slots/${roleId}/rollback`, "/api/bo/pinoria/ward/catalog", "/api/bo/pinoria/ward/catalog/items", `/api/bo/pinoria/ward/catalog/items/${roleId}`, "/api/bo/pinoria/ward/catalog/variants", `/api/bo/pinoria/ward/catalog/variants/${roleId}`, "/api/bo/learners", "/api/bo/practice/authoring-context", "/api/bo/practice/repertoire-access/context", "/api/bo/practice/repertoire-access", "/api/bo/practice/repertoire-access/grants", `/api/bo/practice/repertoire-access/grants/${roleId}/revoke`, "/api/bo/practice/resources", "/api/bo/practice/media", `/api/bo/practice/resources/${roleId}`, `/api/bo/practice/resources/${roleId}/drafts`, `/api/bo/practice/versions/${roleId}`, `/api/bo/practice/versions/${roleId}/pages`, `/api/bo/practice/versions/${roleId}/publish`, "/api/bo/open-studio/operations", "/api/bo/open-studio/passes", "/api/bo/open-studio/listings",
    ...
    "/api/bo/workforce/staff-records", "/api/bo/workforce/staff-onboarding", "/api/bo/workforce/staff-registration-settings", "/api/bo/workforce/staff-registration-requests", "/api/bo/workforce/timekeeping", `/api/bo/workforce/timekeeping/${roleId}/corrections`, `/api/bo/workforce/timekeeping/${roleId}/resolve-missed-checkout`, "/api/bo/workforce/planning/check-in-exceptions", "/api/bo/workforce/planning/check-in-exceptions/centers", `/api/bo/workforce/planning/check-in-exceptions/${roleId}`, `/api/bo/workforce/planning/check-in-exceptions/${roleId}/approve`, `/api/bo/workforce/planning/check-in-exceptions/${roleId}/decline`, `/api/bo/workforce/staff-registration-requests/${roleId}/approve`, `/api/bo/workforce/staff-registration-requests/${roleId}/reject`, "/api/bo/workforce/training/catalog", "/api/bo/workforce/training/modules", `/api/bo/workforce/training/modules/${roleId}/next-draft`, `/api/bo/workforce/training/modules/${roleId}/retire`, `/api/bo/workforce/training/assignments/${roleId}/signoff`, `/api/bo/workforce/training/qualifications/${roleId}/revoke`, "/api/bo/workforce/planning/weekly", "/api/bo/workforce/planning/assignment", "/api/bo/workforce/planning/assignment/cancel",
