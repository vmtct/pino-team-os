...
type BoScopeBootstrap = {
  ...
  runningClasses: Array<{ id: string; centerId: string; pathProgramId: string; operationalName: string; weekdayIso: number; windowStartsLocal: string; windowEndsLocal: string; optimalConcurrentCapacity: number; status: string }>;
};
